...
import Asclepio.Produto.dto.ProdutoRequest;
...
import Asclepio.exception.BadRequestException;
import Asclepio.exception.NotFoundException;
...
public class ProdutoService {
    ...
    public void deletar(Long id) {
        ...
        // Deleta a imagem salva no R2/S3 caso exista
        if (produto.getImagemUrl() != null && !produto.getImagemUrl().isBlank()) {
            storageService.deletar(produto.getImagemUrl());
        }
